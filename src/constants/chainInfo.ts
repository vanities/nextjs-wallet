const celoCircleLogoUrl = "/images/celoCircle.png";
const ethereumLogoUrl = "/images/ethereum-logo.png";
const polygonCircleLogoUrl = "/images/polygonCircle.png";
const arbitrumCircleLogoUrl = "/svg/arbitrum_logo.svg";
const arbitrumLogoUrl = "/svg/arbitrum_logo.svg";
const celoLogo = "/svg/celo_logo.svg";
const optimismLogoUrl = "/svg/optimistic_ethereum.svg";
const polygonMaticLogo = "/svg/polygon-matic-logo.svg";
...
export const AVERAGE_L1_BLOCK_TIME = 1200;
